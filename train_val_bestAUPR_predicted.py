...
# predicted structure
root_dir = '/home/mijia/GLM-EP/data/'
train_path= root_dir + 'Train.txt'
test_path= root_dir + 'Test.txt'
all_702_path = root_dir +  'all.txt'
#pkl_path= root_dir + 'residue_feas_PHSA.pkl'
pkl_path= root_dir + 'residue_feas_PSA.pkl' #加H意味着用HMM特征
esm2_5120_path= root_dir + 'esm2/'
#esm2_33_path = root_dir + 'ESM2-t36/'
dis_path= root_dir + 'psepos_SC.pkl'
pdb_folder_path = '/home/mijia/GLM-EP/data/pdb_dir/'
...
#nohup python train_val_bestAUPR_predicted.py > U-EGNNet_1_layer.log 2>&1 &