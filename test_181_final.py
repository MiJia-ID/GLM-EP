...
parser.add_argument("--dataset_path", type=str, default='/home/mijia/GLM-EP/data/')
parser.add_argument("--edgefeats_path", type=str, default='/home/mijia/GLM-EP/data/dataset_dir_181/Test_181/edge_features/EdgeFeats_predicted_SC_17_181.pkl')
parser.add_argument("--model_path", type=str, default='/home/mijia/GLM-EP/Model/')
...
test_path = root_dir + 'Test_181.txt'
pkl_path = root_dir + 'dataset_dir_181/residue_feas_PSA.pkl'
esm2_5120_path= root_dir + 'esm2/'
dis_path= root_dir + 'dataset_dir_181/psepos_SC.pkl'
